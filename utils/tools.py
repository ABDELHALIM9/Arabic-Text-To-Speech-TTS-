...
#         plt.close()
    ...
    # Select the first mel spectrogram (assuming batch size > 1)
    mel_spectrogram = mel_predictions_np[0]  # Shape: (num_mels, time_steps)

    # Plot the Mel spectrogram
    plt.figure(figsize=(10, 4))
    librosa.display.specshow(mel_spectrogram, sr=sampling_rate, x_axis="time", y_axis="mel", cmap="magma")
